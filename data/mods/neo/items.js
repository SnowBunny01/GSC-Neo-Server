...
let BattleItems = {
	"nevermeltice": {
		...
		desc: "Holder's Ice-type attacks have 1.4x power.",
	},
	"blackbelt": {
		inherit: true,
		onBasePower(basePower, user, target, move) {
		...
		desc: "Holder's Fighting-type attacks have 1.4x power.",
	},
	"blackglasses": {
		inherit: true,
		onBasePower(basePower, user, target, move) {
		...
		desc: "Holder's Dark-type attacks have 1.4x power.",
	},
	"charcoal": {
		inherit: true,
		onBasePower(basePower, user, target, move) {
		...
		desc: "Holder's Fire-type attacks have 1.4x power.",
	},
	berryjuice: {
		inherit: true,
		isUnreleased: false,
